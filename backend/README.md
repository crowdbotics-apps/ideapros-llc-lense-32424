...
## Project Structure
    ...
    ├── ideapros_llc_lense_32424  # Django project configurations
...
1. Clone this repo and `cd ideapros_llc_lense_32424`
...
2. Clone this repo and `cd ideapros_llc_lense_32424`
